...
import dev.norska.dwaddon.pp.update.UpdateChecker;
...
public class UpdateHandler {
	...
	public void checkForUpdates(PPAddon main) {
	...
	public void sendUpdateMessage(PPAddon main, CommandSender cms, Boolean join) {
		if (updateAvailable) {
				cms.sendMessage("");
